<template lang="html">
  <section id="dates">
    ...
    <a class="button" target="_blank" href="http://talks.aurelien-loyer.fr/">View all talks</a>
...
export default {
  ...
  data() {
    return {
      past: [
        {
          text: "Devoxx France 2017"
        },
        {
          text: "Devfest Lille 2017"
        },
        {
          text: "Meetup GDG Lille"
        },
        {
          text: "Devoxx France 2018"
        },
        {
